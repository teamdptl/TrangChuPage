...
<body>
    ...
    <div style="margin: 0 20px;">
        <?php 
        include 'TrangChuPHP\header-trangchu.php';
        include 'TrangChuPHP\caurosel-trangchu.php';
        include 'TrangChuPHP\flimShowing-trangchu.php';
        include 'TrangChuPHP\flimLater-trangchu.php';
...
<script src="./TrangChuJS/index.js" async defer></script>
</body>
